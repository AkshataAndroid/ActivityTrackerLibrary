...
public abstract class AppBasePartialHtmlFragment extends AppBasePartialFragment implements  View.OnTouchListener, View.OnLongClickListener{
    ...
    private View displayHTMLView(LayoutInflater inflater, ViewGroup container){
        ...
        try {
            ...
            webView = new AppWebView(getActivity().getBaseContext(), inAppNotification.getWidth(), inAppNotification.getHeight(), inAppNotification.getWidthPercentage(), inAppNotification.getHeightPercentage());
            InAppWebViewClient webViewClient = new InAppWebViewClient();
            webView.setWebViewClient(webViewClient);
            webView.setOnTouchListener(AppBasePartialHtmlFragment.this);
            webView.setOnLongClickListener(AppBasePartialHtmlFragment.this);
