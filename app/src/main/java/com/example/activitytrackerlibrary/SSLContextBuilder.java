...
final class SSLContextBuilder {
    ...
    SSLContext build(){
        try{
            ...
            InputStream inputStream1 = new BufferedInputStream(getClass().getClassLoader().getResourceAsStream("com/tracker/android/sdk/certificates/DigiCertGlobalRootCA.crt"));
            ...
            InputStream inputStream2 = new BufferedInputStream(getClass().getClassLoader().getResourceAsStream("com/tracker/android/sdk/certificates/DigiCertSHA2SecureServerCA.crt"));
