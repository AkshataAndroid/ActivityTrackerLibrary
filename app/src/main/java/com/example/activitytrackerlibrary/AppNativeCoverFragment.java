...
public class AppNativeCoverFragment extends AppBasenativeFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if(inAppNotification.getInAppMediaForOrientation(currentOrientation) != null) {
            if (inAppNotification.getImage(inAppNotification.getInAppMediaForOrientation(currentOrientation)) != null) {
                ...
                imageView.setTag(0);
                imageView.setOnClickListener(new AppNativeButtonClickListener());
            }
        }
        ...
        ArrayList<AppNotificationButton> buttons = inAppNotification.getButtons();
        if(buttons.size() ==1){
            ...
            for(int i=0; i < buttons.size(); i++) {
                ...
                AppNotificationButton inAppNotificationButton = buttons.get(i);
