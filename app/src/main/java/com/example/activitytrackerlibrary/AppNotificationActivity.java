...
public class AppNotificationActivity extends FragmentActivity implements AppBaseFragment.InAppListener {
    ...
    private AppBaseFullFragment createContentFragment() {
        InAppType type = inAppNotification.getInAppType();
        AppBaseFullFragment viewFragment = null;
        switch (type) {
            case AppTypeCoverHTML: {
                viewFragment = new AppHtmlCoverFragment();
                break;
            }
            case AppTypeInterstitialHTML: {
                viewFragment = new AppHtmlInterstitialFragment();
                break;
            }
            case AppTypeHalfInterstitialHTML: {
                viewFragment = new AppHtmlHalfInterstitialFragment();
                break;
            }
            case AppTypeCover: {
                viewFragment = new AppNativeCoverFragment();
                break;
            }
//            case AppTypeInterstitial: {
//                viewFragment = new AppNativeInterstitialFragment();
//                break;
//            }
//            case AppTypeHalfInterstitial: {
//                viewFragment = new AppNativeHalfInterstitialFragment();
//                break;
//            }
//            case AppTypeCoverImageOnly: {
//                viewFragment = new AppNativeCoverImageFragment();
//                break;
//            }
//            case AppTypeInterstitialImageOnly: {
//                viewFragment = new AppNativeInterstitialImageFragment();
//                break;
//            }
//            case AppTypeHalfInterstitialImageOnly: {
//                viewFragment = new AppNativeHalfInterstitialImageFragment();
//                break;
//            }
            case AppTypeAlert: {
                ...
                if (inAppNotification.getButtons().size() > 0) {
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        alertDialog = new AlertDialog.Builder(AppNotificationActivity.this, android.R.style.Theme_Material_Light_Dialog_Alert)
                                .setCancelable(false)
                        ...
                        alertDialog = new AlertDialog.Builder(AppNotificationActivity.this)
                                .setCancelable(false)
                                .setTitle(inAppNotification.getTitle())
                                .setMessage(inAppNotification.getMessage())
                                .setPositiveButton(inAppNotification.getButtons().get(0).getText(), new DialogInterface.OnClickListener() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setListener((InAppActivityListener) TrackerApi.instanceWithConfig(getApplicationContext(), config));
        } catch (Throwable t) {
        ...
        AppBaseFullFragment contentFragment;
    ...
    @Override
    public void inAppNotificationDidClick(InAppNotification inAppNotification, Bundle formData, HashMap<String, String> keyValueMap) {
    ...
    @Override
    public void inAppNotificationDidShow(InAppNotification inAppNotification, Bundle formData) {
        didShow(formData);
    }

    interface InAppActivityListener {
        void inAppNotificationDidShow(InAppNotification inAppNotification, Bundle formData);

        void inAppNotificationDidClick(InAppNotification inAppNotification, Bundle formData, HashMap<String, String> keyValuePayload);

        void inAppNotificationDidDismiss(Context context, InAppNotification inAppNotification, Bundle formData);
    }

    @Override
    public void inAppNotificationDidDismiss(final Context context, final InAppNotification inAppNotification, Bundle formData) {
        didDismiss(formData);
    }
