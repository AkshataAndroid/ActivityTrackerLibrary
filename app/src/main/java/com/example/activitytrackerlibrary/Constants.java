...
public class Constants {
    static final String TRACKER_ACCOUNT_ID = "TRACKER_ACCOUNT_ID";
    static final String TRACKER_TOKEN = "TRACKER_TOKEN";
    static final String TRACKER_NOTIFICATION_ICON = "TRACKER_NOTIFICATION_ICON";
    static final String TRACKER_INAPP_EXCLUDE = "TRACKER_INAPP_EXCLUDE";
    static final String TRACKER_REGION = "TRACKER_REGION";
    static final String TRACKER_DISABLE_APP_LAUNCH = "TRACKER_DISABLE_APP_LAUNCHED";
    static final String TRACKER_SSL_PINNING = "TRACKER_SSL_PINNING";
    static final String TRACKER_BACKGROUND_SYNC = "TRACKER_BACKGROUND_SYNC";
    static final String TRACKER_CUSTOM_ID = "TRACKER_USE_CUSTOM_ID";
    static final String TRACKER_USE_GOOGLE_AD_ID = "TRACKER_USE_GOOGLE_AD_ID";
    static final String TRACKER_FCM_SENDER_ID = "FCM_SENDER_ID";
    static final String TRACKER_PACKAGE_NAME = "TRACKER_APP_PACKAGE";
    static final String TRACKER_BETA = "TRACKER_BETA";
    static final String TRACKER_INTENT_SERVICE = "TRACKER_INTENT_SERVICE";
    static final String TRACKER_OPTOUT = "ct_optout";
    static final String TRACKER_STORAGE_TAG = "WizRocket";
    static final String TRACKER_LOG_TAG = "TRACKER";
    ...
    public static String API_URL="http://13.233.194.100:4000/";
    public static String EVENT_PING_ALIVE="pingAlive";
    ...
    public static String EVENT_STATUS_CHECK;
    ...
    static final String KEY_ENABLE_CUSTOM_CT_ID = "getEnableCustomTRACKERId";
    ...
    static final String CUSTOM_TRACKER_ID_PREFIX = "__h";
    ...
    static final Set<String> PROFILE_IDENTIFIER_KEYS = new HashSet<>(Arrays.asList(
            "Identity", "Email", "FacebookID", "GoogleID"));
