...
public class DisplayUnitContent implements Parcelable {
    ...
    private DisplayUnitContent(String title, String titleColor, String message, String messageColor,
    ...
    private DisplayUnitContent(Parcel in) {
        title = in.readString();
     ...
     * @return - AppDisplayUnitContent - can have empty fields with an error message in case of parsing error
     */
    static DisplayUnitContent toContent(JSONObject contentObject) {
        try {
            ...
            return new DisplayUnitContent(title, titleColor, message, messageColor,
                    icon, media, contentType, posterUrl,
                    actionUrl, null);

        } catch (Exception e) {
            Logger.d(Constants.FEATURE_DISPLAY_UNIT,"Unable to init AppDisplayUnitContent with JSON - " + e.getLocalizedMessage());
            return new DisplayUnitContent("", "", "", "", "", "", "", "", "", "Error Creating DisplayUnit Content from JSON : " + e.getLocalizedMessage());
        }
    }
    ...
    /**
     * Method to check whether media in the {@link DisplayUnitContent} object is an image.
     *
    ...
    /**
     * Method to check whether media in the {@link DisplayUnitContent} object is a GIF.
     *
    ...
    /**
     * Method to check whether media in the {@link DisplayUnitContent} object is a video.
     *
    ...
    /**
     * Method to check whether media in the {@link DisplayUnitContent} object is an audio.
     *
    ...
    public static final Creator<DisplayUnitContent> CREATOR = new Creator<DisplayUnitContent>() {
        @Override
        public DisplayUnitContent createFromParcel(Parcel in) {
            return new DisplayUnitContent(in);
        }

        @Override
        public DisplayUnitContent[] newArray(int size) {
            return new DisplayUnitContent[size];
        }
    };
