...
public class AppNotificationButton implements Parcelable {
    ...
    protected AppNotificationButton(Parcel in) {
        text = in.readString();
    ...
    AppNotificationButton initWithJSON(JSONObject jsonObject) {
        try {
    ...
    @SuppressWarnings("unused")
    public static final Parcelable.Creator<AppNotificationButton> CREATOR = new Parcelable.Creator<AppNotificationButton>() {
        @Override
        public AppNotificationButton createFromParcel(Parcel in) {
            return new AppNotificationButton(in);
        }

        @Override
        public AppNotificationButton[] newArray(int size) {
            return new AppNotificationButton[size];
        }
    };
}
