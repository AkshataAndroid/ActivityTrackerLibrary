...
public class TrackerMessageDAO {
    private String id;
    ...
    private TrackerMessageDAO(String id, JSONObject jsonData, boolean read, long date, long expires, String userId, List<String> tags, String campaignId, JSONObject wzrkParams){
        this.id = id;
        this.jsonData = jsonData;
        this.read = read;
        this.date = date;
    ...
    static TrackerMessageDAO initWithJSON(JSONObject inboxMessage, String userId){
        try {
            ...
            return (id == null) ? null: new TrackerMessageDAO(id, cellObject, false,date,expires,userId, tagsList,campaignId,wzrkParams);
