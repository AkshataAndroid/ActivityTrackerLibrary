...
public class AppHtmlCoverFragment extends AppBaseFullFragment {
    ...
    private View displayHTMLView(LayoutInflater inflater, ViewGroup container) {
        ...
        try {
            ...
            if (inAppNotification.isJsEnabled()) {
                ...
                webView.addJavascriptInterface(new WebInterface(TrackerApi.instanceWithConfig(getActivity(), config)), "App");
            }
