...
public abstract  class AppBaseFragment extends Fragment {
    ...
    private WeakReference<AppBaseFragment.InAppListener> listenerWeakReference;
    ...
    void handleButtonClickAtIndex(int index) {
        try {
            AppNotificationButton button = inAppNotification.getButtons().get(index);
    ...
    interface InAppListener {
        ...
        void inAppNotificationDidClick(InAppNotification inAppNotification, Bundle formData, HashMap<String, String> keyValueMap);

        void inAppNotificationDidDismiss(Context context, InAppNotification inAppNotification, Bundle formData);
    }

    class AppNativeButtonClickListener implements View.OnClickListener {
        @Override
